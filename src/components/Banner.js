        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-20'>
          <div className='flex-1 text-center font-secondary lg:text-left lg:gap-x-12'>
            ...
            >
              ...
              <TypeAnimation sequence={['Developer', 2000, 'Freelancer', 2000]} speed={50} className='text-accent' wrapper='span' repeat={Infinity} />
            </motion.div>
            <motion.p
              variants={fadeIn('up', 0.4)}
              initial="hidden"
              whileInView="show"
              viewport={{ once: false, amount: 0.7 }}
              className='mb-8 max-w-lg mx-auto lg:mx-0 text-blue-50'
            >
            ...
            <motion.div
              ...
              whileInView="show"
              viewport={{ once: false, amount: 0.7 }}
              className='flex text-[25px] gap-x-6 max-w-max mx-auto lg:mx-0 items-center text-blue-50'
            >
              <a href='https://www.linkedin.com/in/sonali0525/'><FaLinkedinIn /></a>
              <a href='https://github.com/Sammandy'><FaGithub /></a>
              <a href='https://x.com/Sandy_2325'><FaTwitter /></a>
              <a href='https://www.instagram.com/_sammandy25/'><FaInstagram /></a>
            </motion.div>
          </div>
          <motion.div
